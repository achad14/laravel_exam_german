...
<body>
    ...
    <div class="container">
        <h2 class="text-center mt-5 mb-3">Fill up the form</h2>
        <div class="card">
        ...
        <div class="modal-dialog" >
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label for="created_at">Enter Date:</label>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        if (typeof errors.created_at !== 'undefined') 
                        {
                            created_atValidation = '<li>' + errors.created_at[0] + '</li>';
                        }
         
        let errorHtml = '<div class="alert alert-danger" role="alert">' +
            '<b>Validation Error!</b>' +
            '<ul>' + nameValidation + descriptionValidation + created_atValidation + '</ul>' +
        '</div>';
        ...
        function editProject(id)
        {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#created_at").val(project.created_at);
                    $("#form-modal").modal('show'); 
                },
                error: function(response) {
                    console.log(response.responseJSON)
    ...
    $("#created_at-info").html(project.created_at);
